...
# metadata
metadata = {
    'protocolName': 'OTV1_GlcPeakAnalysisONECELL_BigFalconRack',
...
if whichSteps == "medium" or whichSteps == "all":
    ...
    # Distribute M9 in first three wells of first column
    curWells = plate.cols(0)
    ...
    # Distribute M9 in all but first and last column
    for curRow in range(6):
        curWells = plate.rows(curRow)[1:-1]
