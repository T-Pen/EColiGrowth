...
trough = labware.load('opentrons_10_tuberack_falcon_4x50ml_6x15ml_conical', '6')  # Load reservoir
...
CellSourceGlc =  trough.wells("C1") 
CellSourceAce =  trough.wells("C2")          #50 ml falcon with dye added as baseline and  gradient
GlcSource =   trough.wells("B3")
AceSource =   trough.wells("B4")
M9Source = trough.wells("A3")
...
sourceVolumes = {"CellSourceGlc"  : 3000,
                 "CellSourceAce"  : 3000,
                 "GlcSource"   : 50000,
                 "AceSource"   : 50000,
...
if whichSteps == "cells" or whichSteps == "all":
    ...
    for curRow in range(6):
        ...
        if curRow in range(3):
            CellSource = CellSourceGlc
            CellSourcelab = "CellSourceGlc"
        else:
            CellSource = CellSourceAce
            CellSourcelab = "CellSourceAce"
        ...
        transfer_fillhgt(100,
                         ...
                         pipette,
                         fillhgt_falcon50000,
                         sourceVolumes[CellSourcelab],
                         pipettingParameters,
                         new_tip = "once"
                         )
        sourceVolumes[CellSourcelab] = _new_fillvol